! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            t = Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "6265b150-8c4c-4faf-888b-84fc13ba3cc4", e._sentryDebugIdIdentifier = "sentry-dbid-6265b150-8c4c-4faf-888b-84fc13ba3cc4")
    } catch (e) {}
    ...
    [9831], {
        ...
        44325: function(e, t, s) {
            ...
            function c(e) {
                let {
                    ...
                    suffix: s = !1,
                    className: a = ""
                } = e, [n, i] = (0, o.useState)(!1);
                return (0, r.jsxs)("span", {
                    className: (0, d.Z)("cursor-pointer", n && "z-10 relative", a),
                    onClick: () => {
                        i(!n)
                    },
            ...
            function i(e) {
                ...
                return (0, r.jsx)(r.Fragment, {
                    children: (0, r.jsx)("button", {
                        ...
                        color: d,
                        disabled: c,
                        className: (0, a.Z)(m, "inline-flex items-center rounded font-medium shadow-sm focus:outline-none focus:ring-2", l[t], n[d], c ? "opacity-75" : ""),
                        id: u,
                        children: s
                    })
                })
        ...
        35270: function(e, t, s) {
            ...
            let h = (0, d.forwardRef)((e, t) => {
                let {
                    ...
                    className: x = "",
                    showText: p = !1,
                    setDownloaded: g = null
                } = e, v = (0, i.Dv)(o.LF), [y, f] = (0, i.KO)(o.pG), [j, b] = (0, d.useState)(!1), w = (0, d.useRef)(0), N = (0, d.useRef)(!1), _ = (0, c.Z)();
                async function k(e) {
                    b(!0);
                    try {
                        let {
                            zipSync: t
                        } = await s.e(3778).then(s.bind(s, 93778)), r = (await s.e(3162).then(s.t.bind(s, 93162, 23))).default, l = (await s.e(707).then(s.bind(s, 50707))).default, n = await fetch("https://api.comick.io" + "/v1.0/chapter/".concat(e, "/download"), {
                            credentials: "include"
                        }), i = await n.json(), o = await l(i.images, async e => {
                            let t = "https://" + (0, a.po)() + "/" + e,
                                s = await fetch(t, {
                                    cache: "no-store"
                                }).then(e => e.arrayBuffer());
                            return w.current = w.current + 1 / i.images.length * 100, _(), {
                                key: e,
                        ...
                        for (let e of o) d[e.key] = e.binary;
                        let c = t(d);
                        r.saveAs(new Blob([c], {
                            type: "application/octet-stream"
                        }), i.safe_title + ".zip", !0), w.current = 0, f(e);
                        try {
                            u.event({
                                action: "download",
                                options: {
                    ...
                    g && y.includes(h) && g(!0)
                }, [y, h, g]), (0, d.useImperativeHandle)(t, () => ({
                    handleClick: Z
                }));
                let Z = async e => {
                    v.data.identity ? (g && g(!0), j || await k(h)) : alert("Login required.")
                };
                return w.current > 0 ? (0, r.jsxs)("span", {
                    children: [Math.round(w.current), (0, r.jsx)("span", {
                        children: "%"
                    })]
                }) : (0, r.jsxs)("span", {
                    className: "cursor-pointer flex items-center space-x-1",
                    onClick: Z,
                    children: [y.includes(h) ? (0, r.jsx)(l.Z, {
        ...
        33941: function(e, t, s) {
            ...
            function d() {
                let e = (0, r.NL)(),
                    ...
                    s = (0, o.Dv)(i.LF);
                return (0, a.D)({
                    mutationFn: r => (0, l.Z)("https://api.comick.io/follow", {
                        body: JSON.stringify({
                            id: r.id,
                            t: r.type
                        }),
                        ...
                        return 0 == r.type ? l = l.filter(e => e != r.hid) : l.includes(r.hid) || l.push(r.hid), t.mutate({
                            list: l
                        }), e.invalidateQueries({
                    ...
                    onSuccess: (t, s) => {
                        e.setQueryData(["get_follow_by_user", s.id], e => ((null == e ? void 0 : e.follow) || e || (e = {}), e.follow = t, e))
                    }
                })
            }
        },
        45518: function(e, t, s) {
            ...
            function u(e) {
                let {
                    title: t
                } = e, s = (0, a.Z)(), u = (0, n.Z)(), h = (0, i.Dv)(d.LF), x = (0, i.b9)(d.dq), p = (0, m.useRouter)();
                return ((0, c.useEffect)(() => (x(!1), () => {
                    x(!0)
                }), [x]), h.data.identity) ? (0, r.jsxs)("div", {
                    children: [(0, r.jsx)("h1", {
        ...
        42057: function(e, t, s) {
            ...
            function n(e) {
                ...
                return s ? (0, r.jsx)(a.Z, {
                    className: (0, l.Z)("animate-spin text-blue-500", "md" == t ? "h-8 w-8" : "h-6 w-6")
                }) : (0, r.jsxs)("div", {
                    className: (0, l.Z)("inline-flex relative leading-none items-center text-center"),
        ...
        53147: function(e, t, s) {
            ...
            function d() {
                let [e, t] = (0, a.KO)(l.nW), s = (0, a.Dv)(l.LF), d = (0, n.NL)();
                return a => {
                    let {
                        comicId: l,
                        nextId: n = null,
                    ...
                    return new Promise(a => {
                        if (!s.data.identity || e === c) return a(!0);
                        let h = new URL("https://api.comick.io/last_read");
                        return t(c), (0, i.Z)(h.href, {
                            method: "POST",
                            credentials: "include",
                            mode: "cors",
                            headers: {
                            ...
                            d.invalidateQueries({
                                ...
                                queryKey: ["comic_ids_current_user_list"]
                            }), u && o.ZP.success((0, r.jsxs)("span", {
                                children: ["Marked ", (0, r.jsx)("strong", {
                                    children: u
                                }), " as last read"]
                            })), a(!0)
                        }).catch(e => {
        ...
        79530: function(e, t, s) {
            ...
            function w(e) {
                ...
                let {
                    ...
                    queryKey: ["get_follow_by_user", c.id],
                    queryFn: async () => (0, v.Z)("https://api.comick.io/user/follow/comic/" + c.id, {
                        credentials: "include",
                        mode: "cors"
                    }),
                    enabled: !!c && !!(null == u ? void 0 : null === (i = u.data) || void 0 === i ? void 0 : null === (l = i.identity) || void 0 === l ? void 0 : l.id) && !!(null == u ? void 0 : null === (d = u.data) || void 0 === d ? void 0 : null === (o = d.info) || void 0 === o ? void 0 : o.list) && u.data.info.list.includes(c.hid)
                }), f = (0, p.b9)(x.Q);
                return (0, n.useEffect)(() => {
                    var e, t, s;
                    (null == h ? void 0 : null === (e = h.follow) || void 0 === e ? void 0 : e.md_chapters) && ((null == h ? void 0 : null === (s = h.follow) || void 0 === s ? void 0 : null === (t = s.md_chapters2) || void 0 === t ? void 0 : t.hid) ? f(h.follow.md_chapters2.hid) : h.follow.md_chapters.hid && f(h.follow.md_chapters.hid))
                }, [null == h ? void 0 : null === (t = h.follow) || void 0 === t ? void 0 : t.md_chapters, null == h ? void 0 : null === (a = h.follow) || void 0 === a ? void 0 : null === (s = a.md_chapters2) || void 0 === s ? void 0 : s.hid, f]), (0, r.jsxs)("div", {
            ...
            function N(e) {
                ...
                return n || l.isLoading ? (0, r.jsx)("button", {
                    className: (0, j.Z)("md:w-96 h-12 btn px-2 py-3 flex-1"),
                    children: (0, r.jsx)(f.Z, {
                        size: "sm",
                        iconOnly: !0
                    })
                }) : l.data.identity && (null == s ? void 0 : null === (t = s.follow) || void 0 === t ? void 0 : t.type) ? (0, r.jsxs)("select", {
                    className: (0, j.Z)("flex-1 mt-0 py-3 px-2 h-12 border border-gray-300 dark:bg-gray-700 dark:border-gray-700 rounded"),
                    ...
                    className: (0, j.Z)("md:w-96 h-12 btn px-2 py-3 flex-1", i.isPending ? "disabled" : ""),
                    onClick: () => {
            ...
            function _(e) {
                ...
                let m, {
                    ...
                    b = "flex-1 md:w-96 h-12 btn btn-primary px-2 py-3 flex items-center rounded";
                return ((g || p.isLoading) && (m = (0, r.jsxs)(r.Fragment, {
                ...
                })), p.data.identity && (null == h ? void 0 : h.follow) || !v || (m = (0, r.jsxs)(o(), {
                    href: (0, y.nb)({
                        slug: x.slug,
                    ...
                    className: (0, j.Z)(b, "flex truncate flex-1"),
                    children: [(0, r.jsx)(u.Z, {
                        className: "w-6 h-6"
                    }), (0, r.jsx)("span", {
                        className: "text-base font-semibold ml-1",
                ...
                })), (null == h ? void 0 : null === (t = h.follow) || void 0 === t ? void 0 : t.md_chapters) ? m = (0, r.jsxs)(o(), {
                    href: (0, y.nb)({
                        slug: x.slug,
                ...
                }) : (null == h ? void 0 : null === (s = h.follow) || void 0 === s ? void 0 : s.md_chapters2) ? m = (0, r.jsxs)(o(), {
                    href: (0, y.nb)({
                        slug: x.slug,
                        hid: null === (n = h.follow.md_chapters2) || void 0 === n ? void 0 : n.hid,
                        chap: null === (i = h.follow.md_chapters2) || void 0 === i ? void 0 : i.chap,
                        lang: null === (d = h.follow.md_chapters2) || void 0 === d ? void 0 : d.lang,
                        vol: null === (c = h.follow.md_chapters2) || void 0 === c ? void 0 : c.vol
                    }),
                    className: (0, j.Z)(b, "flex truncate flex-1"),
                    children: [(0, r.jsx)(u.Z, {
                        className: "w-6 h-6"
            ...
            function S(e) {
                let {
                    ...
                    scroll: n = !1,
                    nextPrev: i
                } = e, d = (0, l.useRouter)(), c = Math.ceil(t / s);
                if (isNaN(c) || c < 2) return null;
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsxs)("div", {
                        ...
                        id: "pagination",
                        children: [i ? d.query.page && Number(d.query.page) > 1 ? (0, r.jsxs)(o(), {
                            prefetch: !1,
                            scroll: n,
                            shallow: a,
                            href: {
                        ...
                        }) : null, i ? Number(d.query.page) >= c ? (0, r.jsxs)("div", {
                        ...
                        children: ["Showing", " ", (Number(d.query.page ? d.query.page : 1) - 1) * s + 1, " to", " ", Number(d.query.page ? d.query.page : 1) * s, " of ", t, " ", "items"]
                    }), (0, r.jsxs)("nav", {
                        className: "flex flex-wrap container m-auto",
                        role: "navigation",
                        "aria-label": "pagination",
                        children: [1 == Number(d.query.page ? d.query.page : 1) ? (0, r.jsx)("div", {
                            ...
                            let s = "";
                            return ((d.query.page || 0 != t) && t + 1 != Number(d.query.page) || (s = "bg-blue-500 text-gray-300"), t > 48) ? null : (0, r.jsx)(o(), {
                                scroll: n,
                                shallow: a,
                                prefetch: !1,
                                href: {
                        ...
                        }), Number(d.query.page) == c ? (0, r.jsx)("div", {
            ...
            function V(e) {
                ...
                let {
                    ...
                    langList: u,
                    checkVol2Chap1: h
                } = e, f = (0, l.useRouter)(), b = (0, Z.NL)(), w = (0, T.Z)(), N = function(e) {
                    var t, s;
                    let r = (0, l.useRouter)(),
                        a = (0, p.Dv)(x.LF);
                    return (0, g.a)({
                        ...
                        queryFn: async () => {
                            ...
                            return (null === (s = a.data.info) || void 0 === s ? void 0 : null === (t = s.language) || void 0 === t ? void 0 : t.length) > 0 && l.searchParams.append("lang", a.data.info.language.join(",")), r.query.lang && (l.searchParams.delete("lang"), l.searchParams.append("lang", String(r.query.lang))), "all" == r.query.lang && l.searchParams.delete("lang"), r.query["chap-order"] && l.searchParams.append("chap-order", String(+r.query["chap-order"])), r.query["date-order"] && l.searchParams.append("date-order", String(+r.query["date-order"])), r.query.page && l.searchParams.append("page", String(r.query.page)), r.query.chap && (l.searchParams.append("chap", String(r.query.chap)), l.searchParams.delete("page")), (0, v.Z)(l.href, {
                                mode: "cors"
                            })
                        },
                        enabled: !!e && r.isReady,
                ...
                return (null === (s = N.data) || void 0 === s ? void 0 : null === (t = s.chapters) || void 0 === t ? void 0 : t.length) > 0 && N.data.chapters.map(e => {
                    var t, s, r;
                    (null === (s = e.group_name) || void 0 === s ? void 0 : null === (t = s[0]) || void 0 === t ? void 0 : t.match(/official/i)) && !_.includes("Official") && _.push("Official"), (null === (r = e.md_chapters_groups) || void 0 === r ? void 0 : r.length) > 0 && e.md_chapters_groups.map(e => {
                        _.includes(e.md_groups.title) || _.push(e.md_groups.title)
                    })
                }), (0, r.jsxs)("div", {
                    children: [(0, r.jsx)("h2", {
                        id: "chapter-header",
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)(L.Z, {
                                ...
                                children: [u.length, " languages", " ", (0, r.jsx)("span", {
                            ...
                            children: (0, r.jsxs)("select", {
                                ...
                                value: null !== (d = f.query.lang) && void 0 !== d ? d : "",
                                children: [(0, r.jsx)("option", {
                                    value: "",
                                    ...
                                    var t;
                                    return (null === y.Qi || void 0 === y.Qi ? void 0 : null === (t = y.Qi[e]) || void 0 === t ? void 0 : t.nativeName) ? (0, r.jsx)("option", {
                                        value: e,
                            ...
                            return (0, r.jsx)("i", {
                                ...
                                className: "flag-icon flag-icon-".concat((0, y.sm)(e), "  ml-2 cursor-pointer hover:opacity-60 hidden md:block ") + (f.query.lang == e ? " ring-4 ring-blue-400 " : "")
                            }, t)
                        })]
                    }), (null == N ? void 0 : null === (n = N.data) || void 0 === n ? void 0 : null === (a = n.chapters) || void 0 === a ? void 0 : a.length) > 0 && (0, r.jsxs)("div", {
                        className: "flex justify-center items-center mb-3",
                        children: [(0, r.jsx)("div", {
                            className: "text-sm mx-1",
                            children: "Showing chapters "
                        }), (0, r.jsx)("strong", {
                            children: null !== (c = N.data.chapters[N.data.chapters.length - 1].chap) && void 0 !== c ? c : 0
                        }), (0, r.jsx)("div", {
                            className: "text-sm mx-1",
                            children: "to"
                        }), (0, r.jsx)("strong", {
                            children: N.data.chapters[0].chap
                        }), (0, r.jsx)("div", {
                            className: "text-sm mx-1",
                            children: "- page"
                        }), (0, r.jsxs)("strong", {
                            children: [f.query.page ? f.query.page : 1, "/", Math.ceil(N.data.total / N.data.limit)]
                        })]
                    }), (0, r.jsx)("div", {
                        className: "max-xl:overflow-auto 2xl:min-w-6xl 3xl:min-w-8xl items-stretch justify-between w-full",
                        children: (0, r.jsxs)("table", {
                            className: (0, j.Z)("table-fixed w-full whitespace-nowrap", N.isFetching && "opacity-50"),
                                    ...
                                    children: [(0, r.jsx)("th", {
                                        ...
                                        children: (0, r.jsxs)("div", {
                                            ...
                                            children: [(0, r.jsxs)("div", {
                                                ...
                                                children: [(0, r.jsxs)("span", {
                                                    ...
                                                    children: ["Chap", " "]
                                                }), void 0 == f.query["chap-order"] && window.location.search.match(/\?/) ? (0, r.jsx)(D.Z, {
                                                    className: "w-4 h-4 md:w-6 md:h-6 ml-1"
                                                }) : "1" == f.query["chap-order"] ? (0, r.jsx)(P.Z, {
                                        ...
                                        children: (0, r.jsxs)("div", {
                                            ...
                                            children: [(0, r.jsx)("div", {
                                                className: "text-gray-400 dark:text-gray-400 ",
                                                children: "Uploaded"
                                            }), void 0 != f.query["date-order"] ? "0" == f.query["date-order"] ? (0, r.jsx)(O.Z, {
                                        ...
                                        children: (null == _ ? void 0 : _.length) > 0 ? (0, r.jsxs)("select", {
                    ...
                    }), "error" == N.status && (0, r.jsx)("div", {
                        className: "text-center text-red-500",
                        children: "An error has occurred"
                    }), (0, r.jsx)("div", {
                        className: "mt-3",
                        children: (null === (o = N.data) || void 0 === o ? void 0 : null === (i = o.chapters) || void 0 === i ? void 0 : i.length) > 0 && !f.query.chap ? (0, r.jsx)(S, {
                            total: N.data.total,
                            limit: N.data.limit
                        }) : null
                    })]
            ...
            function B(e) {
                ...
                return d.isLoading ? (0, r.jsx)("tbody", {
                    children: (0, r.jsx)("tr", {
                        children: (0, r.jsx)("td", {
                            colSpan: 4,
                            children: (0, r.jsx)("div", {
                ...
                }) : d.failureCount > 0 ? (0, r.jsx)("tbody", {
                    children: (0, r.jsx)("tr", {
                        children: (0, r.jsx)("td", {
                            colSpan: 4,
                            children: (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsxs)(M.Z, {
                                    type: "error",
                                    children: ["Failed to load " + d.failureCount, " "]
                                })
                            })
                        })
                    })
                }) : (null === (s = d.data) || void 0 === s ? void 0 : null === (t = s.chapters) || void 0 === t ? void 0 : t.length) == 0 ? 0 == i.chapter_count ? (0, r.jsx)("tbody", {
                    children: (0, r.jsx)("tr", {
                        children: (0, r.jsx)("td", {
                            colSpan: 3,
                    ...
                    children: (null === (n = d.data) || void 0 === n ? void 0 : null === (a = n.chapters) || void 0 === a ? void 0 : a.length) > 0 && d.data.chapters.filter(e => {
                        var t, s;
            ...
            function H(e) {
                ...
                let {
                    ...
                    checkVol2Chap1: f,
                    queryClient: b
                } = e, w = (0, p.Dv)(x.LF), N = (0, I.Z)(), _ = (0, p.Dv)(x.Q), [k, Z] = (0, n.useState)(!1), [q, C] = (0, n.useState)(!1);
                if ((null == h ? void 0 : null === (t = h.md_chapters_groups) || void 0 === t ? void 0 : t.some(e => "danke-fuers-lesen-k1itlii1" == e.md_groups.slug)) && !(null == w ? void 0 : null === (a = w.data) || void 0 === a ? void 0 : null === (s = a.identity) || void 0 === s ? void 0 : s.id)) return null;
                let S = "border-t dark:border-gray-700";
                g < 1 && (S = "");
                let L = !1;
                _ == h.hid && (L = !0);
                let D = [];
                return h.chap || "0" === h.chap ? D.push((0, r.jsx)("span", {
                    className: f ? "" : "font-semibold",
                    title: "Chapter " + h.chap,
                    children: "Ch. ".concat(h.chap)
                }, "chap" + g)) : D.push((0, r.jsx)(n.Fragment, {}, "empty" + g)), h.vol && D.push((0, r.jsx)("span", {
                    className: f ? "font-semibold" : "",
                    children: " Vol. ".concat(h.vol, " ")
                }, "vol" + g)), f && h.vol && D.reverse(), (g < 3 && u.final_chapter && h.chap == u.final_chapter || h.is_the_last_chapter) && D.push((0, r.jsx)("span", {
                    className: "ml-2",
                    children: (0, r.jsx)(E.Z, {
                        variant: "gray",
                        children: "END"
                    })
                }, "badge" + g)), h.title && D.push((0, r.jsxs)("span", {
                    className: "text-xs md:text-base",
                    children: [" ", h.title]
                }, "title" + g)), h.chap || h.vol || h.title || (D = (null === (c = u.genres) || void 0 === c ? void 0 : c.includes(262)) || 1 == u.last_chapter && u.translation_completed || 2 == u.status ? [(0, r.jsx)("span", {
                    className: "font-semibold",
                    children: "Oneshot"
                }, "oneshost" + g)] : [(0, r.jsx)("span", {
                    className: "font-semibold",
                    children: "Unknown"
                }, "unknown" + g)]), (0, r.jsxs)("tr", {
                    ...
                    children: [(0, r.jsx)("td", {
                        ...
                        children: (0, r.jsxs)(o(), {
                            ...
                            children: [(0, r.jsxs)("div", {
                                className: "truncate",
                                children: [(0, r.jsx)("i", {
                                    className: "flag-icon mr-2 flag-icon-".concat((0, y.sm)(h.lang), " rounded")
                                }), D]
                            }), !N("sm") && L ? (0, r.jsx)(F.Z, {
                                className: "text-blue-500 group-hover:block hover:brightness-150 w-8 h-8"
                            }) : null, h.up_count - h.down_count != 0 ? (0, r.jsxs)("div", {
                        ...
                        children: h.created_at ? (0, r.jsx)(K.Z, {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("div", {
                                ...
                                children: (null === (l = h.md_chapters_groups) || void 0 === l ? void 0 : l.length) > 0 ? h.md_chapters_groups.map((e, t) => {
                                    var s;
                                    return (0, r.jsxs)("span", {
                                        children: [(null === (s = h.group_name) || void 0 === s ? void 0 : s[0]) == "Official" ? "Official" : (0, r.jsx)(o(), {
                                            href: "/group/".concat(e.md_groups.slug),
                                            prefetch: !1,
                                            className: "link text-blue-400 dark:text-blue-500",
                                            children: e.md_groups.title
                                        }), h.md_chapters_groups.length > 1 && t < h.md_chapters_groups.length - 1 ? (0, r.jsx)("span", {
                                            className: "text-gray-500",
                                            children: ", "
                                        }) : null]
                                    }, "group" + t + h.id)
                                }) : (null === (i = h.group_name) || void 0 === i ? void 0 : i.length) > 0 ? (0, r.jsx)("span", {
                                ...
                                children: (null === (d = h.identities) || void 0 === d ? void 0 : d.traits) && (0, r.jsxs)("div", {
                                    className: "flex items-center",
                                    children: [(0, r.jsx)(Q.Z, {
                                        className: "w-4 h-4"
                                    }), h.identities.traits.username && (0, r.jsx)(o(), {
                                        prefetch: !1,
                            ...
                            children: N("sm") && (k || q || L) ? (0, r.jsxs)("div", {
                                className: (0, j.Z)((k || q || L) && "flex inset-y-0 items-center w-10 justify-end gap-4"),
                                children: [(0, r.jsx)("div", {
                                    onClick: () => {
                                        w.data.info ? v({
                                            comicId: u.id,
            ...
            function ep(e) {
                ...
                let {
                    comic: c,
                    recommendable: m
                } = e, [u, h] = (0, n.useState)(!1), y = (0, p.Dv)(x.LF), b = (0, Z.NL)(), {
                    isLoading: w,
                    data: N
                } = function(e, t, s) {
                    var r, a, l;
                    ...
                    return (0, g.a)({
                        ...
                        queryFn: async () => (0, v.Z)("https://api.comick.io" + "/recommendations?hid=".concat(e), {
                            credentials: "include",
                            mode: "cors"
                        }),
                    ...
                    queryFn: async e => {
                        ...
                        return await (0, v.Z)("https://api.comick.io" + "/comic/".concat(i, "/recommendations") + (t ? "?page=" + t : ""), {
                            mode: "cors"
                        })
                    },
                    initialPageParam: 1,
                ...
                })), C = (null == _ ? void 0 : null === (t = _.pages) || void 0 === t ? void 0 : t.length) > 0 ? _.pages.flatMap(e => e) : [];
                y.data.info.accept_mature_content || (C = C.filter(e => "safe" == e.relates.content_rating)), y.data.info.accept_erotic_content || (C = C.filter(e => "safe" == e.relates.content_rating || "suggestive" == e.relates.content_rating));
                let [S, {
                    push: L,
                    set: D,
                    updateAt: F
                ...
                let {
                    ...
                    mutationFn: e => (0, v.Z)("https://api.comick.io/recommendations/add", {
                        body: JSON.stringify({
                            hid: e.hid,
                            relates: S.map(e => ({
                    ...
                    onSuccess: () => {
                        b.invalidateQueries({
                            queryKey: ["recommendations", c.hid]
                        }), b.invalidateQueries({
                            queryKey: ["user_recommendations", c.hid]
                        }), b.invalidateQueries({
                            queryKey: ["user"]
                        }), ex.ZP.success("Your recommendations were saved."), h(!1)
                    }
                });
                return (0, r.jsxs)(r.Fragment, {
                    children: [u && (0, r.jsx)(el.Z, {
                        open: u,
                        onClose: () => h(!1),
                        title: "Add Recommendation",
                        position: "center",
                        children: P ? w ? (0, r.jsx)(f.Z, {}) : (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsx)("div", {
                                className: "mt-3",
                                children: (0, r.jsx)(ei.Z, {
                                    ...
                                    getSources: e => {
                                        ...
                                        return s.append("q", t), s.append("user_id", y.data.identity.id), [{
                                            sourceId: "databases",
                                            async getItems() {
                                                let e = await (0, v.Z)("https://api.comick.io/search/suggestion_in_mylist?" + s.toString(), {
                                                    mode: "cors"
                                                }).catch(e => []);
                                                return (null == e ? void 0 : e.length) > 0 && (e = e.filter(e => !(null == S ? void 0 : S.some(t => t.recommendations.hid == e.hid)) && e.hid != c.hid)), e
                                            },
                                            onSelect(e) {
                                                let {
                                                    item: t,
                            ...
                            }), (null == S ? void 0 : S.length) > 0 ? (0, r.jsxs)(r.Fragment, {
                                children: [(0, r.jsx)("div", {
                                    className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 mt-3",
                                    children: S.map((e, t) => (0, r.jsxs)("a", {
                                        href: "/comic/" + e.recommendations.slug,
                                        target: "_blank",
                                        className: (0, j.Z)("relative flex items-center space-x-3 rounded-lg border border-gray-300 dark:border-gray-700 p-2 md:p-3 lg:p-4 !pr-1 shadow-sm hover:dark:border-gray-500 ", "delete" == e.recommendations.type && "opacity-30"),
                                        children: [(0, r.jsx)("div", {
                                            ...
                                            }), -1 == e.score && "delete" != e.recommendations.type ? (0, r.jsx)(er.Z, {
                                                className: (0, j.Z)("w-5 h-5 text-red-500 fill-red-500")
                                            }) : null, 1 == e.score && (0, r.jsx)(ea.Z, {
                                                className: (0, j.Z)("w-5 h-5 text-green-600 fill-green-600")
                                            })]
                                        })]
                    ...
                    }), m && (null == C ? void 0 : C.length) > 0 ? (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            children: C.map(e => {
                                ...
                                if ((null == N ? void 0 : N.length) > 0)
                                    for (let r of N) r.recommendations.hid == e.relates.hid && (1 == r.score ? t = !0 : s = !0);
                                return (0, r.jsxs)("div", {
                                    ...
                                    children: [(0, r.jsxs)("div", {
                                        ...
                                        children: [(0, r.jsx)(d.Z, {
                                            ...
                                            children: [(0, r.jsxs)("div", {
                                                onClick: () => {
                                                    (0, v.Z)("https://api.comick.io/recommendations/add", {
                                                        body: JSON.stringify({
                                                            hid: c.hid,
                                                            relates: [{
                                                                hid: e.relates.hid,
                                                        ...
                                                        ex.ZP.success('You upvoted "'.concat(e.relates.title, '"')), b.invalidateQueries({
                                                            queryKey: ["recommendations", c.hid]
                                                        }), b.invalidateQueries({
                                                            queryKey: ["user_recommendations", c.hid]
                                                        }), b.invalidateQueries({
                                                ...
                                                children: [(0, r.jsx)("div", {
                                                    ...
                                                    children: (0, r.jsx)(ea.Z, {
                                                        className: (0, j.Z)("w-4 h-4 md:w-5 md:h-5", t ? "text-green-600  hover:text-green-500" : "text-gray-400 hover:text-gray-300")
                                                    })
                                                }), (0, r.jsx)("div", {
                                                ...
                                                children: (0, r.jsx)(er.Z, {
                                                    className: (0, j.Z)("w-4 h-4 md:w-5 md:h-5 cursor-pointer", s ? "text-red-500 fill-red-500" : "text-gray-400 hover:text-gray-300"),
                                                    onClick: () => {
                                                        (0, v.Z)("https://api.comick.io/recommendations/add", {
                                                            body: JSON.stringify({
                                                                hid: c.hid,
                                                            ...
                                                            ex.ZP.success('You downvoted "'.concat(e.relates.title, '"')), b.invalidateQueries({
                                                                queryKey: ["recommendations", c.hid]
                                                            }), b.invalidateQueries({
                                                                queryKey: ["user_recommendations", c.hid]
                                                            }), b.invalidateQueries({
            ...
            function eg() {
                let e = (0, p.Dv)(x.LF),
                    t = (0, l.useRouter)();
                return e.data.identity ? null : (0, r.jsx)(el.Z, {
                    open: !0,
                    onClose: () => null,
            ...
            function eb(e) {
                var t, s, i, d, c, m, u, h, g, v, f, b, N, _, Z, q, C, S;
                let {
                    comic: L,
                    langList: D,
                    authors: F,
                    ...
                    firstChap: T,
                    recommendable: K
                } = e, z = (0, I.Z)(), E = (0, k.Z)(), A = (0, l.useRouter)(), [B, H] = (0, n.useState)(!1), G = (0, p.Dv)(x.LF), Y = (0, p.Dv)(x.zS);
                if ((0, n.useEffect)(() => {
                        (0, ev.zD)().then(e => e.detect()).then(e => {
                            e.bot && H(!0)
                        }).catch(e => console.error(e))
                    }), A.isFallback || !L) return (0, r.jsx)(a.Z, {});
                let W = !1;
                ((null === (t = L.links) || void 0 === t ? void 0 : t.engtl) || L.noindex) && (W = !0), "kr" == L.country && (W = !0), (null === (i = L.mu_comics) || void 0 === i ? void 0 : null === (s = i.mu_comic_publishers) || void 0 === s ? void 0 : s.length) > 0 && (null === (d = L.mu_comics) || void 0 === d ? void 0 : d.mu_comic_publishers.some(e => ["kadokawa", "shueisha", "kodansha", "shogakukan", "viz", "00-shu-cream-pop", "houbunsha", "mag-garden"].includes(e.mu_publishers.slug))) && (W = !0);
                let X = !1;
                console.log('AAAA que eh o negoico, changes made to content rating');
                console.log(L);
                L.content_rating = "safe";
                return ((L.md_comic_md_genres.some(e => "incest" == e.md_genres.slug) || !1 == L.adsense) && (X = !0), "erotica" != L.content_rating || !E || B || (null === (m = G.data) || void 0 === m ? void 0 : null === (c = m.info) || void 0 === c ? void 0 : c.accept_erotic_content)) ? (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(eN, {
                        comic: L,
                        noindex: W
                    }), "erotica" == L.content_rating || X ? null : (0, r.jsx)(r.Fragment, {
                        children: (0, r.jsx)($.Z, {})
                    }), function(e, t, s) {
                        var a, l;
                        let n = (null === (l = e.md_covers) || void 0 === l ? void 0 : null === (a = l[0]) || void 0 === a ? void 0 : a.b2key) ? "https://" + (0, y.po)() + "/" + e.md_covers[0].b2key : "https://comick.io/static/unicorn-512.png";
                        return (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsx)(U(), {
                        ...
                        matureContent: O
                    }), "erotica" == L.content_rating && (0, r.jsx)("div", {
                        className: "my-3",
                        children: (0, r.jsx)(ef, {})
                    }), E && L.login_required ? (0, r.jsx)(eg, {}) : null, (0, r.jsxs)("div", {
                        className: (0, j.Z)("xl:max-w-screen-xl mx-auto space-y-20 divide-gray-500", Y ? "mt-1 md:mt-2 md:pt-2 lg:pt-3 xl:pt-4" : "mt-6 lg:mt-16"),
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("h1", {
                                ...
                                className: (0, j.Z)("mr-4 relative", (null === (h = L.mu_comics) || void 0 === h ? void 0 : null === (u = h.mu_comic_categories) || void 0 === u ? void 0 : u.length) > 0 ? "row-span-5" : "row-span-4"),
                                children: (0, r.jsx)(ew, {
                                    comic: L
                                })
                            }), (0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsxs)("div", {
                                    ...
                                    children: [(0, r.jsx)("span", {
                                        className: "text-gray-500 dark:text-gray-400",
                                        children: "Status: "
                                    }), 1 == L.status ? (0, r.jsx)("span", {
                                        children: "\uD83D\uDCD6 Ongoing"
                                    }) : null, 2 == L.status ? (0, r.jsx)("span", {
                                        children: "\uD83D\uDCD7 Completed"
                                    }) : null, 3 == L.status ? (0, r.jsx)("span", {
                                        children: "⏹️ Cancelled"
                                    }) : null, 4 == L.status ? (0, r.jsx)("span", {
                                        children: "⏸️ Hiatus"
                                    }) : null]
                                }), (0, r.jsxs)("div", {
                                    children: [(0, r.jsxs)("span", {
                                    ...
                                    }), !0 === L.translation_completed ? (0, r.jsx)("span", {
                                        children: "\uD83D\uDCD7 Completed"
                                    }) : !1 === L.translation_completed ? (0, r.jsx)("span", {
                                        children: "\uD83D\uDCD6 Ongoing"
                                    }) : (0, r.jsx)("span", {
                                        className: "text-gray-500",
                                        children: "Unknown"
                                    })]
                                }), L.final_chapter || L.final_volume ? (0, r.jsxs)("div", {
                                    children: [(0, r.jsxs)("span", {
                                        className: "text-gray-500 dark:text-gray-400",
                                        children: ["Final Chapter:", " "]
                                    }), L.final_volume ? (0, r.jsxs)("span", {
                                        children: ["Volume ", L.final_volume, ", "]
                                    }) : null, L.final_chapter ? (0, r.jsxs)("span", {
                                    ...
                                    children: [(0, r.jsxs)("div", {
                                        ...
                                        }), " ", (null == L ? void 0 : L.follow_count) ? (0, r.jsx)("span", {
                                            className: "text-[9px] align-top"
                                        }) : null]
                                    })]
                                }), E && L.bayesian_rating ? (0, r.jsx)(eZ, {
                                ...
                                children: [(0, r.jsxs)("div", {
                                    ...
                                    children: [(0, r.jsxs)("div", {
                                            ...
                                            children: (0, r.jsxs)("tbody", {
                                                children: [(0, r.jsxs)("tr", {
                                                    ...
                                                    children: [(0, r.jsxs)("td", {
                                                        ...
                                                        className: "pl-2",
                                                        children: (null == P ? void 0 : P.length) > 0 && P.map((e, t) => (0, r.jsxs)("span", {
                                                            children: [(0, r.jsx)(o(), {
                                                                href: "/people/" + e.slug,
                                                                prefetch: !1,
                                                                className: "link",
                                                    ...
                                                    children: [(0, r.jsxs)("td", {
                                                        ...
                                                        className: "pl-2",
                                                        children: (null == F ? void 0 : F.length) > 0 && F.map((e, t) => (0, r.jsxs)("span", {
                                                            children: [(0, r.jsx)(o(), {
                                                                href: "/people/" + e.slug,
                                                                prefetch: !1,
                                                                className: "link",
                                                ...
                                                }), (null === (v = L.md_comic_md_genres) || void 0 === v ? void 0 : v.length) > 0 && (null === (f = L.md_comic_md_genres.filter(e => "Genre" == e.md_genres.group || "Content" == e.md_genres.group)) || void 0 === f ? void 0 : f.length) > 0 && (0, r.jsxs)("tr", {
                                                    className: " mt-1",
                                                    children: [(0, r.jsxs)("td", {
                                                        ...
                                                        className: "pl-2",
                                                        children: L.md_comic_md_genres.filter(e => "Genre" == e.md_genres.group || "Content" == e.md_genres.group).map((e, t) => (0, r.jsxs)("span", {
                                                            children: [0 != t ? (0, r.jsx)("span", {
                                                                children: ", "
                                                            }) : "", (0, r.jsx)(o(), {
                                                ...
                                                }), (null === (b = L.md_comic_md_genres) || void 0 === b ? void 0 : b.length) > 0 && (null === (N = L.md_comic_md_genres.filter(e => "Theme" == e.md_genres.group)) || void 0 === N ? void 0 : N.length) > 0 && (0, r.jsxs)("tr", {
                                                    className: " mt-1",
                                                    children: [(0, r.jsxs)("td", {
                                                        className: "text-gray-500 dark:text-gray-400 flex-shrink-0",
                                                        children: ["Theme:", " "]
                                                        ...
                                                        className: "pl-2",
                                                        children: L.md_comic_md_genres.filter(e => "Theme" == e.md_genres.group).map((e, t) => (0, r.jsxs)("span", {
                                                            children: [0 != t ? (0, r.jsx)("span", {
                                                                children: ", "
                                                            }) : "", (0, r.jsx)(o(), {
                                                                href: "/search?genres=" + e.md_genres.slug,
                                                ...
                                                }), (null === (_ = L.md_comic_md_genres) || void 0 === _ ? void 0 : _.length) > 0 && (null === (Z = L.md_comic_md_genres.filter(e => "Format" == e.md_genres.group)) || void 0 === Z ? void 0 : Z.length) > 0 && (0, r.jsxs)("tr", {
                                                    className: " mt-1",
                                                    children: [(0, r.jsxs)("td", {
                                                        className: "text-gray-500 dark:text-gray-400 flex-shrink-0",
                                                        children: ["Format:", " "]
                                                        ...
                                                        className: "pl-2",
                                                        children: L.md_comic_md_genres.filter(e => "Format" == e.md_genres.group).map((e, t) => (0, r.jsxs)("span", {
                                                            children: [0 != t ? (0, r.jsx)("span", {
                                                                children: ", "
                                                            }) : "", (0, r.jsx)(o(), {
                                                                href: "/search?genres=" + e.md_genres.slug,
                                                ...
                                                }), (null === (q = L.mu_comics) || void 0 === q ? void 0 : q.mu_comic_publishers.length) > 0 && (0, r.jsxs)("tr", {
                                                    className: " mt-1",
                                                    children: [(0, r.jsxs)("td", {
                                                        className: "text-gray-500 dark:text-gray-400 flex-shrink-0",
                                                        children: ["Publishers:", " "]
                                                        ...
                                                        className: "pl-2",
                                                        children: L.mu_comics.mu_comic_publishers.map((e, t) => (0, r.jsxs)("span", {
                                                            children: [0 != t ? (0, r.jsx)("span", {
                                                                children: ", "
                                                            }) : "", (0, r.jsx)(o(), {
                                        ...
                                        children: E && (0, r.jsx)(ek, {
                                            comic: L
                                        })
                                    })]
                                }), (null === (S = L.mu_comics) || void 0 === S ? void 0 : null === (C = S.mu_comic_categories) || void 0 === C ? void 0 : C.length) > 0 ? (0, r.jsx)(eq, {
                        ...
                        }), z("xl") || "erotica" == L.content_rating || X ? null : (0, r.jsx)(r.Fragment, {}), (0, r.jsx)("div", {
            ...
            function ew(e) {
                ...
                let i = (0, p.Dv)(x.LF),
                    c = (0, k.Z)(),
                    m = "";
                return (i.data.info.accept_mature_content || "erotica" != s.content_rating && "suggestive" != s.content_rating || (m = "suggestive" == s.content_rating ? "blur-sm" : "blur"), (null === (t = s.md_covers) || void 0 === t ? void 0 : t.length) > 0) ? (0, r.jsxs)("div", {
                    className: "relative",
                    children: [(0, r.jsx)(o(), {
                        prefetch: !1,
                        ...
                        children: c && (0, r.jsx)(d.Z, {
                            src: s.md_covers[0],
                            alt: s.title,
                            className: (0, j.Z)("rounded w-full mb-2 md:mb-3 lg:mb-4", m),
                            type: "cover",
                            priority: !0,
                            objectFit: "contain",
                            objectPosition: "top",
            ...
            function eN(e) {
                ...
                let o, {
                    ...
                    u = "";
                return o = d.desc ? "\uD83D\uDCD6 " + (o = (u = d.desc.replace(/(<([^>]+)>)/gi, "")).length > 160 ? u.substr(0, 160) : u) : "Read " + d.title, d.country, d.country, (0, r.jsx)(c.PB, {
                    title: d.title,
                    description: o,
                    canonical: "/comic/".concat(d.slug),
                    robotsProps: {
                        noimageindex: !0
                    },
                    noindex: m,
                    ...
                    openGraph: {
                        ...
                        title: d.title,
                        description: o,
                        ...(null === (s = d.md_covers) || void 0 === s ? void 0 : null === (t = s[0]) || void 0 === t ? void 0 : t.b2key) && d.md_covers[0].h ? {
                            images: [{
                                url: "https://" + (0, y.po)() + "/" + d.md_covers[0].b2key,
                                alt: "".concat(d.title, " image cover"),
                                height: null === (l = d.md_covers) || void 0 === l ? void 0 : null === (a = l[0]) || void 0 === a ? void 0 : a.h,
                                width: null === (i = d.md_covers) || void 0 === i ? void 0 : null === (n = i[0]) || void 0 === n ? void 0 : n.w
                            }]
                        } : {}
                    }
                })
            ...
            function e_(e) {
                ...
                try {
                    let e;
                    if (!t) return null;
                    for (let n in e = t, t = Object.keys(e).sort().reduce((t, s) => (t[s] = e[s], t), {})) {
                        let e, i;
                        switch (n) {
                            case "al":
                                e = "https://anilist.co/manga/" + t[n];
                                break;
                            case "amz":
                            case "cdj":
                            case "ebj":
                                ...
                                break;
                            case "ap":
                                e = "https://www.anime-planet.com/manga/" + t[n];
                                break;
                            case "bw":
                                e = "https://bookwalker.jp/series/" + t[n];
                                break;
                            case "kt":
                                e = "https://kitsu.io/manga/" + t[n];
                                break;
                            case "mal":
                                e = "https://myanimelist.net/manga/" + t[n];
                                break;
                            case "mu":
                                e = Number(t[n]) == t[n] ? "https://www.mangaupdates.com/series.html?id=" + t[n] : "https://www.mangaupdates.com/series/" + t[n];
                                break;
                            case "nu":
                                e = "https://www.novelupdates.com/series/" + t[n];
                                break;
                            case "raw":
                                t[n].match(/naver/), e = t[n];
                                break;
                            case "engtl":
                                e = t[n].replace("?utm_source=mgd", "?utm_source=comick")
                        } - 1 == e.indexOf("utm_source=comick") && (e.match(/\?/) ? e += "&utm_source=comick" : e += "?utm_source=comick"), i = "raw" == n ? (0, r.jsxs)("div", {
                            title: "Raw link",
                        ...
                        let o = (0, r.jsx)("a", {
                            ...
                            className: "flex",
                            children: i
                        }, "link" + n); - 1 != ["mu", "nu", "mal", "kt", "ap", "al"].indexOf(n) ? s.push(o) : -1 != ["raw", "engtl"].indexOf(n) ? l.push(o) : a.push(o)
                    }
                    if ((!l || 0 == l.length) && (!s || 0 == s.length) && (!a || 0 == a.length)) return null
                } catch (e) {
                    return null
                }
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)("h3", {
                        ...
                        children: l
                    }) : null, s.length > 0 ? (0, r.jsx)("div", {
                        className: "flex py-2",
                        children: s
                    }) : null, a.length > 0 ? (0, r.jsx)("div", {
            ...
            function ek(e) {
                ...
                return t.relate_from.length ? (0, r.jsxs)("div", {
                    children: [(0, r.jsx)("h3", {
                        children: "Relations"
                    }), (0, r.jsx)("table", {
            ...
            function eZ(e) {
                let {
                    rating: t
                } = e, s = Number((t / 2).toFixed()), a = [];
                for (let e = 0; e < s; e++) a.push((0, r.jsx)("span", {
                    children: "⭐"
                }));
                return t && 0 != t ? (0, r.jsx)("div", {
                    className: "flex my-2",
                    children: (0, r.jsxs)("div", {
                        className: "flex items-center",
            ...
            function eq(e) {
                let {
                    categories: t
                } = e, s = t[0].positive_vote > 5, [a, l] = (0, n.useState)(t[0].positive_vote > 5 ? t.filter(e => e.positive_vote - e.negative_vote > 0) : t), [i, d] = (0, n.useState)(!1);
                return (0, r.jsxs)("div", {
                    className: "col-span-3 md:col-span-2 ",
                    children: [(0, r.jsxs)("h3", {
                        className: "font-semibold flex items-end",
                        children: ["Tags", " ", s && (0, r.jsx)("div", {
                            className: "text-xs font-normal ml-2 mb-1 cursor-pointer hover:underline",
                            onClick: () => {
                                i ? l(t.filter(e => e.positive_vote > 0)) : l(t), d(!i)
                            },
                        ...
                        children: a.map((e, s) => {
                            if (!e.mu_categories) return null;
                            let a = "";
                            return t.length > 12 && s / t.length < .3 && (a = "md:text-lg"), (0, r.jsx)("li", {
                                className: (0, j.Z)("text-sm md:text-base ml-1 mt-1 px-2 py-1 rounded bg-gray-100 dark:bg-gray-750 cursor-pointer active:bg-blue-500 hover:bg-gray-200 dark:hover:bg-gray-700", a),
            ...
            function eC(e) {
                if ("jp" == e.country) return (0, r.jsx)("span", {
                    children: "Manga"
                });
                if ("kr" == e.country) return (0, r.jsx)("span", {
                    children: "Manhwa"
                });
                if ("cn" == e.country || "hk" == e.country || "tw" == e.country) return (0, r.jsx)("span", {
                    children: "Manhua"
                });
                let t = (0, y.hU)(e.country);
                return (null == t ? void 0 : t.name) ? (0, r.jsx)("span", {
                    children: t.name
                }) : null
            }
        },
